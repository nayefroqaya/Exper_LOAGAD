...
def run(args):
    ...
    file_path_train = '../NovaAD_Plus/datasets/TH_1G/2_TH_1G_Splitted_Datasets/train_df.pkl'
    file_path_test = '../NovaAD_Plus/datasets/TH_1G/2_TH_1G_Splitted_Datasets/test_df.pkl'
    file_path_val = '../NovaAD_Plus/datasets/TH_1G/2_TH_1G_Splitted_Datasets/val_df.pkl'
