...
def arg_parser():
    ...
    parser.add_argument("--dataset_name", help="which dataset to use", default="SP_150MB_ratio",
                        choices=["HDFS", "BGL", "TH_1G", "TH_2G", "SP_100MB","SP_150MB" ])
    parser.add_argument("--log_file", default="SP_150MB_ratio.log", help="log file name")
